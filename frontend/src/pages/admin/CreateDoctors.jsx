  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:4000/api/admin/doctor/create",
        formData,
        {
          headers: {
        ...
        >
          ...
          <div className="md:col-span-2">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 cursor-pointer text-white p-2 rounded-md font-semibold transition-all disabled:opacity-50"
            >
          ...
          {success && (
            <div className="mt-6 bg-gray-100 border border-gray-300 rounded-md p-4">
              ...
              <p>
                ...
                {success.users.name || "N/A"}
              </p>
              <p>
                <strong>Email :</strong>
                {success.users.email || "N/A"}
              </p>
              <p>
                <strong>PhoneNo :</strong>
                {success.users.phoneNo || "N/A"}
              </p>
              <p>
                <strong>Gender :</strong>
                {success.users.gender || "N/A"}
              </p>
              <p>
                <strong>Age :</strong>
                {success.users.age || "N/A"}
              </p>
              <p>
                <strong>Specialization :</strong>
                {success.doctor.specialization || "N/A"}
              </p>
              <p>
                <strong>Experience :</strong>
                {success.doctor.experience || "N/A"}
              </p>
              <p>
                <strong>Qualification :</strong>
                {success.doctor.qualification || "N/A"}
              </p>
              <p>
                Password: <strong>{success.plainPassword}</strong>
              </p>
              <p>
