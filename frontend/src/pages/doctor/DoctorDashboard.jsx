    ...
    (async () => {
      ...
      try {
        const res = await axios.get(
          "http://localhost:4000/api/doctor/dashboard/counts",
          {
            headers: {
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
          <Card
            ...
            onClick={() => navigate("/doctor-page/appointments-pending")}
          />
          <Card
            title="Booked Appointments"
            value={counts.bookedAppointments}
            onClick={() => navigate("/doctor-page/all-appointments-booked")}
          />
          <Card
            title="Rejected Appointments"
            value={counts.rejectedAppointments}
            onClick={() => navigate("/doctor-page/all-appointments-rejected")}
          />
